...
begin # plot B_0 and B_1
    ...
    fig
    save("project/B. Squeezing along one direction/butterfly_flits_wings/main_butterfly_B_2.pdf", fig)
end
...
begin # plot B_0 and B_1
    ...
    CairoMakie.arrows!(ax11, xs, ys, us, vs, arrowsize = 12, lengthscale = 1, arrowcolor = :red, linecolor = :red)
    fig
    # save("project/B. Squeezing along one direction/butterfly_flits_wings/main_butterfly_B_2.png", fig)
end
...
begin # ϕ
    ...
    hidedecorations!(ax11)
    # fig
    save("project/B. Squeezing along one direction/butterfly_flits_wings/main_butterfly_phi.png", fig)
end
...
begin
    ...
    hidedecorations!(ax11)
    # fig
    save("project/B. Squeezing along one direction/butterfly_flits_wings/main_butterfly_Delta_phi.png", fig)
end
